...
<div class="flex flex-col space-y-2 h-screen">
    ...
    <div class="!mt-auto w-full flex">
        <button on:click={back} class="bg-red-500 hover:bg-red-600 dark:text-white font-bold py-2 px-4 text-2xl basis-1/2">back</button>
        <button on:click={next} class="bg-green-500 hover:bg-green-600 dark:text-white font-bold py-2 px-4 text-2xl basis-1/2">next</button>
    </div>
</div>